# A3(INSTRUCTIONS: Instructions are in parentheses. Please delete all instructions from the summary before submitting it.)
...
This assignment, I implement 2 classes: items and shoppingcart, to make the program running. Inlclude some method to get the membership and discounts. 
